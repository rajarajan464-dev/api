...
android {
  ...
  defaultConfig {
    applicationId = "com.vetri.panchangam.daily"
    minSdk = 24
    targetSdk = 36
    versionCode = 148
    versionName = "14.8"
  ...
  signingConfigs {
    create("release") {
      ...
      val keystoreFile = if (keystoreEnv != null) file(keystoreEnv) else file("${rootDir}/my-upload-key.jks")
      if (keystoreFile.exists() && System.getenv("STORE_PASSWORD") != null) {
        storeFile = keystoreFile
        storePassword = System.getenv("STORE_PASSWORD")
        keyAlias = System.getenv("KEY_ALIAS") ?: "vetri_alias"
  ...
  buildTypes {
    ...
    debug {
      ...
      if (dbgConfig.storeFile != null && dbgConfig.storeFile?.exists() == true) {
